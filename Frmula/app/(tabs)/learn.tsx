    ...
    >
      ...
      <View style={styles.cardMeta}>
        ...
        <View style={styles.metaItem}>
          ...
          <Text style={styles.metaText}>{topic.content.length} sections</Text>
        </View>
        <View style={styles.metaDot} />
        <View style={styles.metaItem}>
          <Ionicons name="help-circle" size={14} color={Colors.textTertiary} />
          <Text style={styles.metaText}>{topic.quiz.length} questions</Text>
        </View>
      </View>
      {topic.videoId && (
    ...
    <View style={styles.container}>
      <View style={[styles.header, { paddingTop: topPadding + 8 }]}>
        <View style={styles.headerRow}>
          ...
          <Text style={styles.screenTitle}>LEARN F1</Text>
        </View>
        <Text style={styles.screenSubtitle}>
          {LEARN_TOPICS.length} TOPICS · VIDEOS · QUIZZES
        </Text>
        <LinearGradient
