...
import { useOpenF1Drivers, useOpenF1Meetings } from "@/hooks/useOpenF1";
      ...
      >
        ...
        <View style={[styles.headerWrap, { paddingTop: topPadding + 8 }]}>
          ...
          <View style={styles.headerRow}>
            <Text style={styles.headerSeason}>2026 SEASON · {completed > 0 ? `${completed} OF ${total || 24} ROUNDS` : `${total || 24} ROUNDS`}</Text>
                ...
                <View style={styles.liveBannerLeft}>
                  <View style={styles.liveRow}>
                    ...
                    <Text style={styles.liveLabel}>
                      {liveRace.isLive ? "LIVE NOW" : "RECENT"} · ROUND {liveRace.round}
                    </Text>
                  </View>
        ...
        <View style={[styles.section, { paddingHorizontal: 16 }]}>
          <View style={styles.sectionHdr}>
            <Text style={styles.sectionTitle}>DRIVERS STANDINGS</Text>
            <TouchableOpacity onPress={() => router.push("/(tabs)/standings")}>
              <Text style={styles.sectionMore}>SEE ALL →</Text>
            </TouchableOpacity>
          </View>
        ...
        {nextRace && (
          <View style={[styles.section, { paddingHorizontal: 16 }]}>
            <View style={styles.sectionHdr}>
              ...
              <Text style={styles.sectionBadge}>ROUND {nextRace.round}</Text>
            </View>
