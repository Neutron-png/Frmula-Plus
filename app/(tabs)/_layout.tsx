...
const TAB_CONFIG = [
  ...
  { name: "live", labelKey: "nav.live", icon: "radio-outline", iconActive: "radio" },
  { name: "drivers", labelKey: "nav.drivers", icon: "people-outline", iconActive: "people" },
  { name: "standings", labelKey: "nav.standings", icon: "trophy-outline", iconActive: "trophy" },
  { name: "learn", labelKey: "nav.learn", icon: "school-outline", iconActive: "school" },
  { name: "news", labelKey: "nav.news", icon: "newspaper-outline", iconActive: "newspaper" },
  { name: "more", labelKey: "nav.explore", icon: "grid-outline", iconActive: "grid" },
