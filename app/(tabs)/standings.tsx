  ...
  return (
    <View style={styles.container}>
      <View style={[styles.header, { paddingTop: topPadding + 8 }]}>
        <Text style={styles.screenTitle}>{t("standings.title")}</Text>
        <Text style={styles.screenSeason}>2026 · {completed > 0 ? `${completed} ${t("home.of")} ${total || 24}` : `${total || 24}`} {t("standings.rounds")}</Text>
        <View style={styles.tabRow}>
          <TouchableOpacity
            style={[styles.tab, activeTab === "drivers" && styles.tabActive]}
            onPress={() => setActiveTab("drivers")}
          >
            <Text style={[styles.tabText, activeTab === "drivers" && styles.tabTextActive]}>{t("standings.drivers_tab")}</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={[styles.tab, activeTab === "constructors" && styles.tabActive]}
            onPress={() => setActiveTab("constructors")}
          >
            <Text style={[styles.tabText, activeTab === "constructors" && styles.tabTextActive]}>{t("standings.constructors_tab")}</Text>
          </TouchableOpacity>
        </View>
      </View>
